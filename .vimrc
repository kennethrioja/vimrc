...
function! Class(ClassName)
	...
	call append(4, "")
	call append(5, a:ClassName."::".a:ClassName."(void) : _".tolower(a:ClassName)."(0)")
	call append(6, "{")
	call append(7, "// Default Constructor ")
	...
	call append(11, "}")
	call append(12, "")
	call append(13, a:ClassName."::".a:ClassName."(".a:ClassName." const & src)")
	call append(14, "{")
	call append(15, "// Copy Constructor ")
	...
	call append(20, "}")
	call append(21, "")
	call append(22, a:ClassName." &	".a:ClassName."::operator=(".a:ClassName." const & rhs)")
	call append(23, "{")
	call append(24, "// Copy assignment operator")
	...
	call append(30, "}")
	call append(31, "")
	call append(32, a:ClassName."::~".a:ClassName."(void)")
	call append(33, "{")
	call append(34, "// Default destructor ")
